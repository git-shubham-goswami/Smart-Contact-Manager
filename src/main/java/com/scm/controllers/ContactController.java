...
public class ContactController {
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result, Authentication authentication, HttpSession session){
        ...
        contact.setInstagramLink(contactForm.getFacebookLink());
        ...
        session.setAttribute("message", Message.builder()
                                                    .content("You have successfully added a")
    ...
    public String updateContactFormview(@PathVariable("contactId") String contactId, Model model ){
        ...
        contactForm.setFacebookLink(contact.getInstagramLink());
    ...
    public String updateContact(@Valid @PathVariable("contactId") String contactId, @ModelAttribute ContactForm contactForm, Model model, BindingResult bindingResult){
        ...
        con.setInstagramLink(contactForm.getFacebookLink());
